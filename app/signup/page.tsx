  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome to VeriSight. Your account has been created successfully.",
      })
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-black dark:via-black dark:to-black flex items-center justify-center p-4">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-gray-900 dark:text-white">VeriSight</span>
          </Link>
        </div>
        ...
        <Card className="shadow-lg dark:bg-black dark:border-slate-800">
          <CardHeader className="text-center">
            ...
            <CardDescription className="dark:text-gray-300">
              Join the fight against misinformation with AI-powered detection
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSignUp} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-500 dark:to-purple-500 hover:from-blue-700 hover:to-purple-700 dark:hover:from-blue-600 dark:hover:to-purple-600"
                disabled={isLoading}
              >
